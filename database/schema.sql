...
-- SURGE_ZONE Table (zones = pickup/drop locations)
...
-- TIME_SLOT Table (24-hour coverage in 2-hour blocks)
...
-- RIDE Table (with carpooling + booking type + filters)
CREATE TABLE IF NOT EXISTS Ride (
    ...
    min_driver_rating DECIMAL(3,2) NOT NULL DEFAULT 3.0,
...
-- RIDE_PASSENGER Table (for carpooling - junction table)
...
-- RATING Table (passenger rates driver after ride)
...
INSERT OR IGNORE INTO User (user_id, name, phone, trust_score) VALUES
...
INSERT OR IGNORE INTO Passenger (user_id) VALUES (1),(2),(4),(5),(6);

INSERT OR IGNORE INTO Driver (user_id, license_no, status, rating) VALUES
(3, 'DL-4567890', 'Available', 4.6),
(7, 'DL-7891234', 'Available', 4.4),
(8, 'DL-6543210', 'Available', 4.2);

INSERT OR IGNORE INTO Vehicle (vehicle_id, vehicle_type, registration_no, driver_user_id) VALUES
(101, 'Sedan', 'TN09AB4567', 3),
(102, 'SUV', 'TN10CD5678', 7),
(103, 'Hatchback', 'TN11EF9012', 8);

-- Surge Zones = Pickup/Drop Locations (10 zones)
INSERT OR IGNORE INTO Surge_Zone (zone_id, zone_name, base_fare) VALUES
(1, 'City Center', 80.00),
...
-- Time Slots: 12 x 2-hour blocks covering full 24 hours
INSERT OR IGNORE INTO Time_Slot (timeslot_id, start_time, end_time, surge_multiplier) VALUES
(1, '00:00', '02:00', 1.0),
(2, '02:00', '04:00', 1.0),
(3, '04:00', '06:00', 1.1),
(4, '06:00', '08:00', 1.3),
...
-- Seed Rides (zone_id = pickup location zone)
INSERT OR IGNORE INTO Ride (ride_id, pickup_location, drop_location, ride_status, fare, max_seats, booked_seats, booking_type, is_pool, min_driver_rating, vehicle_type_filter, passenger_user_id, driver_user_id, zone_id, timeslot_id) VALUES
...
INSERT OR IGNORE INTO Ride_Passenger (ride_id, passenger_user_id, fare_share) VALUES
(5001, 1, 140.00),(5002, 4, 120.00),(5003, 5, 180.00),(5004, 6, 180.00),(5005, 2, 240.00);

INSERT OR IGNORE INTO Payment (payment_id, amount, payment_mode, ride_id, passenger_user_id) VALUES
...
-- Seed ratings for completed rides (so rating popup doesn't show for old data)
INSERT OR IGNORE INTO Rating (rating_id, ride_id, from_user_id, to_user_id, stars) VALUES
(1, 5001, 1, 3, 4),
(2, 5002, 4, 7, 5),
(3, 5003, 5, 3, 4),
(4, 5004, 6, 8, 3),
